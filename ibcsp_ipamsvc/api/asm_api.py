...
class AsmApi(object):
    ...
    def asm_create(self, payload_id_application_name, payload_id_resource_type, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.asm_create(payload_id_application_name, payload_id_resource_type, body, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.asm_create_with_http_info(payload_id_application_name, payload_id_resource_type, body, **kwargs)  # noqa: E501
        else:
            (data) = self.asm_create_with_http_info(payload_id_application_name, payload_id_resource_type, body, **kwargs)  # noqa: E501
            return data

    def asm_create_with_http_info(self, payload_id_application_name, payload_id_resource_type, body, **kwargs):  # noqa: E501
        """Create the ASM object.  # noqa: E501

        Use this method to create an ASM object. The ASM object generates and returns the suggestions from the ASM suggestion engine and allows for updating the subnet and range information. When queried it returns the suggested updates for the subnet, when written it attempts to expand the scope by expanding a range or adding a new range and, if necessary, expanding the subnet.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.asm_create_with_http_info(payload_id_application_name, payload_id_resource_type, body, async_req=True)
        >>> result = thread.get()
        ...
        if ('payload_id_application_name' not in params or
            ...
            raise ValueError("Missing the required parameter `payload_id_application_name` when calling `asm_create`")  # noqa: E501
        ...
        if ('payload_id_resource_type' not in params or
            ...
            raise ValueError("Missing the required parameter `payload_id_resource_type` when calling `asm_create`")  # noqa: E501
    ...
    def asm_read(self, id_application_name, id_resource_type, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.asm_read(id_application_name, id_resource_type, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.asm_read_with_http_info(id_application_name, id_resource_type, id, **kwargs)  # noqa: E501
        else:
            (data) = self.asm_read_with_http_info(id_application_name, id_resource_type, id, **kwargs)  # noqa: E501
            return data

    def asm_read_with_http_info(self, id_application_name, id_resource_type, id, **kwargs):  # noqa: E501
        """Read the ASM object.  # noqa: E501

        Use this method to read an ASM object. The ASM object returns the suggested updates for the subnet.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.asm_read_with_http_info(id_application_name, id_resource_type, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id_application_name' not in params or
            ...
            raise ValueError("Missing the required parameter `id_application_name` when calling `asm_read`")  # noqa: E501
        # verify the required parameter 'id_resource_type' is set
        if ('id_resource_type' not in params or
                params['id_resource_type'] is None):
            raise ValueError("Missing the required parameter `id_resource_type` when calling `asm_read`")  # noqa: E501
