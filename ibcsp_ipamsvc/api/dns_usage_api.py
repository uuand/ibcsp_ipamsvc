...
class DnsUsageApi(object):
    ...
    def dns_usage_read(self, id_application_name, id_resource_type, id, **kwargs):  # noqa: E501
        """Read the DNS Usage object. Use this method to read a DNS Usage object.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dns_usage_read(id_application_name, id_resource_type, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.dns_usage_read_with_http_info(id_application_name, id_resource_type, id, **kwargs)  # noqa: E501
        else:
            (data) = self.dns_usage_read_with_http_info(id_application_name, id_resource_type, id, **kwargs)  # noqa: E501
            return data

    def dns_usage_read_with_http_info(self, id_application_name, id_resource_type, id, **kwargs):  # noqa: E501
        """Read the DNS Usage object. Use this method to read a DNS Usage object.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.dns_usage_read_with_http_info(id_application_name, id_resource_type, id, async_req=True)
        >>> result = thread.get()
        ...
        if ('id_application_name' not in params or
            ...
            raise ValueError("Missing the required parameter `id_application_name` when calling `dns_usage_read`")  # noqa: E501
        # verify the required parameter 'id_resource_type' is set
        if ('id_resource_type' not in params or
                params['id_resource_type'] is None):
            raise ValueError("Missing the required parameter `id_resource_type` when calling `dns_usage_read`")  # noqa: E501
