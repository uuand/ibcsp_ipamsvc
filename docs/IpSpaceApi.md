...
# **ip_space_create**
> IpamsvcCreateIPSpaceResponse ip_space_create(payload_id_application_name, payload_id_resource_type, body)
...
body = ibcsp_ipamsvc.IpamsvcIPSpace() # IpamsvcIPSpace | 

try:
    # Create the IP Space object.
    api_response = api_instance.ip_space_create(payload_id_application_name, payload_id_resource_type, body)
    pprint(api_response)
...
# **ip_space_delete**
> ip_space_delete(id_application_name, id_resource_type, id)
...
try:
    # Delete the IP Space object.
    api_instance.ip_space_delete(id_application_name, id_resource_type, id)
except ApiException as e:
...
# **ip_space_read**
> IpamsvcReadIPSpaceResponse ip_space_read(id_application_name, id_resource_type, id, fields=fields)
...
try:
    # Read the IP Space object.
    api_response = api_instance.ip_space_read(id_application_name, id_resource_type, id, fields=fields)
    pprint(api_response)
except ApiException as e:
...
# **ip_space_update**
> IpamsvcUpdateIPSpaceResponse ip_space_update(payload_id_application_name, payload_id_resource_type, id, body)
...
try:
    # Update the IP Space object.
    api_response = api_instance.ip_space_update(payload_id_application_name, payload_id_resource_type, id, body)
    pprint(api_response)
except ApiException as e:
