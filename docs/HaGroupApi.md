...
# **ha_group_create**
> IpamsvcCreateHAGroupResponse ha_group_create(payload_id_application_name, payload_id_resource_type, body)
...
api_instance = ibcsp_ipamsvc.HaGroupApi(ibcsp_ipamsvc.ApiClient(configuration))
...
body = ibcsp_ipamsvc.IpamsvcHAGroup() # IpamsvcHAGroup | 

try:
    # Create the HA Group object.
    api_response = api_instance.ha_group_create(payload_id_application_name, payload_id_resource_type, body)
    pprint(api_response)
...
# **ha_group_delete**
> ha_group_delete(id_application_name, id_resource_type, id)
...
try:
    # Delete the HA Group object.
    api_instance.ha_group_delete(id_application_name, id_resource_type, id)
except ApiException as e:
...
# **ha_group_read**
> IpamsvcReadHAGroupResponse ha_group_read(id_application_name, id_resource_type, id, fields=fields)
...
try:
    # Read the HA Group object.
    api_response = api_instance.ha_group_read(id_application_name, id_resource_type, id, fields=fields)
    pprint(api_response)
except ApiException as e:
...
# **ha_group_update**
> IpamsvcUpdateHAGroupResponse ha_group_update(payload_id_application_name, payload_id_resource_type, id, body)
...
try:
    # Update the HA Group object.
    api_response = api_instance.ha_group_update(payload_id_application_name, payload_id_resource_type, id, body)
    pprint(api_response)
except ApiException as e:
