...
> IpamsvcCreateAddressBlockResponse address_block_create(payload_id_application_name, payload_id_resource_type, body)
...
api_instance = ibcsp_ipamsvc.AddressBlockApi(ibcsp_ipamsvc.ApiClient(configuration))
...
body = ibcsp_ipamsvc.IpamsvcAddressBlock() # IpamsvcAddressBlock | 

try:
    # Create the Address Block object.
    api_response = api_instance.address_block_create(payload_id_application_name, payload_id_resource_type, body)
    pprint(api_response)
...
> IpamsvcCreateNextAvailableIPResponse address_block_create_next_available_ip(id_application_name, id_resource_type, id)
...
try:
    # Create the Next Available IP object.
    api_response = api_instance.address_block_create_next_available_ip(id_application_name, id_resource_type, id)
    pprint(api_response)
except ApiException as e:
...
> address_block_delete(id_application_name, id_resource_type, id)
...
try:
    # Delete the Address Block object.
    api_instance.address_block_delete(id_application_name, id_resource_type, id)
except ApiException as e:
...
> IpamsvcNextAvailableIPResponse address_block_list_next_available_ip(id_application_name, id_resource_type, id, contiguous=contiguous, count=count)
...
try:
    # List Next Available IP objects.
    api_response = api_instance.address_block_list_next_available_ip(id_application_name, id_resource_type, id, contiguous=contiguous, count=count)
    pprint(api_response)
except ApiException as e:
...
# **address_block_read**
> IpamsvcReadAddressBlockResponse address_block_read(id_application_name, id_resource_type, id, fields=fields)
...
try:
    # Read the Address Block object.
    api_response = api_instance.address_block_read(id_application_name, id_resource_type, id, fields=fields)
    pprint(api_response)
except ApiException as e:
...
> IpamsvcUpdateAddressBlockResponse address_block_update(payload_id_application_name, payload_id_resource_type, id, body)
...
try:
    # Update the Address Block object.
    api_response = api_instance.address_block_update(payload_id_application_name, payload_id_resource_type, id, body)
    pprint(api_response)
except ApiException as e:
