...
# **range_create**
> IpamsvcCreateRangeResponse range_create(payload_id_application_name, payload_id_resource_type, body)
...
api_instance = ibcsp_ipamsvc.RangeApi(ibcsp_ipamsvc.ApiClient(configuration))
...
body = ibcsp_ipamsvc.IpamsvcRange() # IpamsvcRange | 

try:
    # Create the Range object.
    api_response = api_instance.range_create(payload_id_application_name, payload_id_resource_type, body)
    pprint(api_response)
...
> IpamsvcCreateNextAvailableIPResponse range_create_next_available_ip(id_application_name, id_resource_type, id)
...
try:
    # Create a Next Available IP object.
    api_response = api_instance.range_create_next_available_ip(id_application_name, id_resource_type, id)
    pprint(api_response)
except ApiException as e:
...
# **range_delete**
> range_delete(id_application_name, id_resource_type, id)
...
try:
    # Delete the Range object.
    api_instance.range_delete(id_application_name, id_resource_type, id)
except ApiException as e:
...
> IpamsvcNextAvailableIPResponse range_list_next_available_ip(id_application_name, id_resource_type, id, contiguous=contiguous, count=count)
...
try:
    # List Next Available IP objects.
    api_response = api_instance.range_list_next_available_ip(id_application_name, id_resource_type, id, contiguous=contiguous, count=count)
    pprint(api_response)
except ApiException as e:
...
# **range_read**
> IpamsvcReadRangeResponse range_read(id_application_name, id_resource_type, id, fields=fields)
...
try:
    # Read the Range object.
    api_response = api_instance.range_read(id_application_name, id_resource_type, id, fields=fields)
    pprint(api_response)
except ApiException as e:
...
# **range_update**
> IpamsvcUpdateRangeResponse range_update(payload_id_application_name, payload_id_resource_type, id, body)
...
try:
    # Update the Range object.
    api_response = api_instance.range_update(payload_id_application_name, payload_id_resource_type, id, body)
    pprint(api_response)
except ApiException as e:
